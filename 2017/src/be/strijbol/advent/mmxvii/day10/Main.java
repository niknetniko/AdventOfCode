package be.strijbol.advent.mmxvii.day10;

import be.strijbol.advent.common.collections.CircularList;
import be.strijbol.advent.common.collections.Selection;
...
public class Main {
    ...
    private static int one() throws IOException {
        ...
        var list = new CircularList<>(IntStream.rangeClosed(0, 255).boxed().collect(Collectors.toList()));
