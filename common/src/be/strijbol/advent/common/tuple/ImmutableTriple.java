 ...
 * cannot add undesirable behaviour.</p>
 *
...
final class ImmutableTriple<L, M, R> extends Triple<L, M, R> {
     ...
     */
    private static final ImmutableTriple<Void, Void, Void> NULL = of(null, null, null);
     ...
     * @since 3.6
     */
    public static ImmutableTriple<Void, Void, Void> nullTriple() {
        return NULL;
    }
